  ...
  <v-container fluid>
    <v-row>
      <v-col md="12" sm="12">
        ...
        <p>
          At DevFest 2024, get ready to debug your routine and upgrade your passion.This year, we're focused on practical learning, meaningful connections, workshops that build solid foundations in tech.Our lineup of talks and sessions is carefully crafted to offer something valuable for everyone, whether you're just starting out or advancing your skills. You’ll leave feeling empowered, equipped, and inspired to take the next step in your journey.
        </p>
      </v-col>
      <v-col
        md="4"
